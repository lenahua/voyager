...
app.get("/hotelInfo/:id", function (req, res) {
  ...
  const getUserReviews = () => {
    return new Promise((resolve, reject) => {
      connection.query(
        "SELECT orderinfo.*, userinfo.account FROM orderinfo JOIN userinfo ON orderinfo.Uid = userinfo.Uid WHERE orderinfo.hotelId = ? AND orderinfo.ratetime IS NOT NULL ORDER BY orderId DESC",
        [hotelId],
